...
export function LinkCreated({ link, dismiss }: LinkCreatedProps) {
  ...
  const expiresDate = link.expires.toISOString(); // {{ ctrl.link.expires | date:'dd/MM/yyyy HH:mm'}}
  ...
  return <div className="c-result">
    ...
    <div className="c-result__row">
      <input className="c-result__link" type="text" id="createdLink" value={ url } readOnly />
